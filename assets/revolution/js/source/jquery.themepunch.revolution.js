...
var getNeededScripts = function(o,c) {	
	...
	if (!c.data('version') || !c.data('version').toString().match(/5./gi)) {
		...
		c.find('.dx, .tp-static-layer, .rs-background-video-layer').each(function(){
			var _nc = jQuery(this);
 ...
 var runSlider = function(container,opt) {
	...
	jQuery.each(opt.allli,function(index,li) {
		...
		if (li.data('link')!=undefined) {
			...
			var apptxt = '<div class="dx slidelink" style="cursor:pointer;width:100%;height:100%;z-index:'+zindex+';" data-x="center" data-y="center" data-basealign="slide" ',
	...
	if (opt.simplifyAll=="on" && (_R.isIE(8) || _R.iOSVersion())) {
		container.find('.dx').each(function() {
			var tc = jQuery(this);
	...
	if (!container.hasClass("revslider-initialised")) {
		...
		container.find('.dx, .rs-background-video-layer').each(function(i) {
			var _nc = jQuery(this),
		...
		container.find('.dx video').each(function(i) {
			var v = jQuery(this);
